...
class SliderResource extends Resource
{
    ...
    protected static ?string $modelLabel = 'Slider / Afiş';
    protected static ?string $pluralModelLabel = 'Slider / Afişler';
    protected static ?string $navigationLabel = 'Slider Yönetimi';
    protected static string | \UnitEnum | null $navigationGroup = 'Site Tasarımı';
